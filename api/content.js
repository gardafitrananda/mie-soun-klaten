    ...
    try {
        ...
        if (req.method === 'PUT') {
            const { 
                ...
                // TAMBAHAN IKON & BADGE HERO
                trust1_icon, trust2_icon, trust3_icon, trust4_icon, trust5_icon,
                hero_badge1_icon, hero_badge1_text, hero_badge2_icon, hero_badge2_text, hero_badge3_icon, hero_badge3_text
            } = req.body;
            ...
            await sql`
                ...
                SET 
                    ...
                    trust1_icon = ${trust1_icon}, trust2_icon = ${trust2_icon}, trust3_icon = ${trust3_icon}, trust4_icon = ${trust4_icon}, trust5_icon = ${trust5_icon},
                    hero_badge1_icon = ${hero_badge1_icon}, hero_badge1_text = ${hero_badge1_text}, 
                    hero_badge2_icon = ${hero_badge2_icon}, hero_badge2_text = ${hero_badge2_text}, 
                    hero_badge3_icon = ${hero_badge3_icon}, hero_badge3_text = ${hero_badge3_text}
                WHERE id = 1
            `;
